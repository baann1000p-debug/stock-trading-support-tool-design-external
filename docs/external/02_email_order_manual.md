...
本書は、本システムが自動配信する**「AI投資アドバイスメール」を受信してから、実際に個人の証券口座（SBI証券、楽天証券、松井証券等）で買い・売り注文を発注し、アプリへ結果を記録するまでの一連の運用手順**を解説する手順書です。

システムのAI分析およびスクリーニング結果は、毎日指定の時刻に登録メールアドレスへ自動配信されます。本手順書に従うことで、感情に左右されないルールベースの規律あるトレードをスムーズに実行できます。
